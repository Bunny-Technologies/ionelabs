            ...
            <div className="flex items-center gap-0.5 sm:gap-1 md:gap-2">
              {navItems.map((item) => (
                <a key={item} href={`#${slugify(item)}`}
                  className="relative text-[10px] sm:text-[11px] md:text-[13px] font-medium text-gray-600 hover:text-gray-900 transition-colors duration-200 tracking-wide uppercase px-1.5 sm:px-2.5 md:px-4 py-1.5 sm:py-2 rounded-md hover:bg-gray-50 group"
                  data-testid={`link-${slugify(item)}`}
                >
                  {item}
                  <span className="absolute bottom-0.5 sm:bottom-1 left-1.5 right-1.5 sm:left-2.5 sm:right-2.5 md:left-4 md:right-4 h-0.5 bg-amber-500 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left rounded-full" />
                </a>
              ))}
            </div>

            <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
              <a href="tel:+919959933363" className="hidden sm:flex items-center gap-2 text-[12px] md:text-[13px] text-gray-500 hover:text-gray-800 transition-colors group" data-testid="link-phone">
              ...
              <a href="#contact">
                <Button className="bg-amber-500 hover:bg-amber-600 text-white font-semibold shadow-sm btn-shimmer text-[10px] sm:text-xs md:text-sm h-8 sm:h-9 md:h-10 px-3 sm:px-4 md:px-5" data-testid="button-get-started">
